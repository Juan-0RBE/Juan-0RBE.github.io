---
title: 'Normalización'
description: 'Trabajos relacionados con normalización'
publishDate: '2026-02-14'
---

- [Taller de repaso](#taller-de-repaso-1)
- [Taller avanzado](#taller-avanzado-de-normalización)

## Taller de repaso

- Realizado el 9 de abril de 2026
...
- Realizado el 17 de abril de 2026

El presente taller avanzado de normalización tiene como objetivo profundizar en el análisis y descomposición de esquemas relacionales complejos hasta alcanzar la Tercera Forma Normal (3FN). A diferencia de ejercicios introductorios, esta actividad incorpora casos de mayor dificultad que incluyen grupos repetidos anidados, dependencias parciales y transitivas, atributos multivaluados y relaciones con múltiples entidades interconectadas. A través de distintos escenarios empresariales, como sistemas de envíos internacionales y plataformas de alquiler de películas, se busca fortalecer la capacidad de identificar llaves primarias y candidatas, analizar dependencias funcionales y construir esquemas relacionales consistentes, eficientes y libres de redundancia.
